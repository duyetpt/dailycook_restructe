...
public class AdminAuth {
    ...
    static void auth(RegisterInfo adminAcc) throws LoginFailException, DAOException {
...
//        } else if (!user.getPassword().equals(EncryptHelper.encrypt(adminAcc.getPassword()))) {
        } else if (!user.getPassword().equals(adminAcc.getPassword()) || user.getRole().equals(User.NORMAL_USER_ROLE)) {
